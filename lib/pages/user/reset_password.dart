...
class _ResetPasswordPageState extends State<ResetPasswordPage> {
  ...
  void _checkFormState() {
    ...
    // 检查四个输入框是否都有内容
    final allFieldsNotEmpty = name.isNotEmpty && email.isNotEmpty && code.isNotEmpty && password.isNotEmpty;
              ...
              Center(
                ...
                children: [
                  Container(
                    width: 300.w,
                    height: 300.w,
                    decoration: BoxDecoration(color: Colors.transparent, borderRadius: BorderRadius.circular(40.r)),
                    child: Center(
                              ...
                              child: Center(
                                child: TextField(
                                  ...
                                  decoration: InputDecoration(
                                      ...
                                      hintText: '邮箱',
                                      hintStyle:
                                          TextStyle(fontSize: 40.sp, color: const Color.fromARGB(255, 198, 198, 198))),
                                  style: TextStyle(
                                    fontSize: 40.sp,
                                    color: Colors.black,
                                  ),
                          ...
                          CupertinoButton(
                              ...
                              child: Stack(children: [
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color: isCodeLoading ? Colors.transparent : Colors.white,
                                    borderRadius: BorderRadius.circular(10.r),
                              ...
                              onPressed: () async {
                                ...
                                var res = await UserApi.sendCode(email: emailController.text);
                                // 判断返回结果
                  ...
                  canRegister
                      ? CupertinoButton(
                          ...
                          child: Container(
                            ...
                            height: 120.h,
                            decoration: BoxDecoration(
                              color: isLoading ? Colors.white.withOpacity(0.5) : kMainColor,
